...
class Circle extends Shape {
  ...
  <text x="50%" y="50%" font-size="175" dominant-baseline="middle" text-anchor: "middle" fill="${this.textColor}">${this.text}</text>
  </svg>`;
  }
}
...
class Square extends Shape {
  render() {
    return `<svg width="500" height="500" xmlns="http://www.w3.org/2000/svg">
    <rect x="500" y="280" width="180" height="180" fill="${this.shapeColor}" />
