...
class Circle extends Shape {
  render() {
    return `<svg width="500" height="500" xmlns="http://www.w3.org/2000/svg"><circle cx="50%" cy="50%" r="50%" fill="${this.shapeColor}" /><text x="22%" y="50%" font-size="175" dominant-baseline="middle" text-anchor: "middle" fill="${this.textColor}">${this.text}</text></svg>`;
  }
}
